defmodule TagTest do
  ...
  test "tag double" do
    ...
    [creation_response, creation_propagation] = Tag.feed(Event.new([:tag, :player], %{id: player_id, tag: tag}), fake_pid)
    ...
    [failure_response] = Tag.feed(Event.new([:tag, :player], %{id: player_id, tag: tag}), fake_pid)
